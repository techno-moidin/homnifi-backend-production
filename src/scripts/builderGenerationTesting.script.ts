...
// Data for the user have 5 downline and 5 are active
// const data = [
//   {
//     id: '8349460488',
//     upline_id: null,
...
async function bootstrap() {
  ...
  // Uncomment below when run this senario : Data for Single Node Upline Tree
  const length = results.length;
  // await service.generateBuilderGenerationReward(
  //   '66fc025f4d779ea4251691dc',
  //   100,
  //   null,
  //   1,
  //   new Types.ObjectId('66fc028d4d779ea425169264'),
  // );

  // Uncomment below when run this senario : Data for the user have 5 downline and 5 are active
  // for (let i = 0; i < results.length; i++) {
  //   await service.generateBuilderGenerationReward(results[i], 100, 1, null);
  // }
